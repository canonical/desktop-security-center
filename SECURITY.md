# How to report a security issue with desktop-security-center

The easiest way to report a security issue is through [GitHub](https://github.com/canonical/desktop-security-center/security/advisories/new).
